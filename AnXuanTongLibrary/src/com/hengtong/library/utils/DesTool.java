...
//			result = StringUtils.base64_encode(desEncrypt(input.getBytes("UTF-8"), keys));
//			result = desEncrypt(input.getBytes(), keys);//String srt2=new String(midbytes,"UTF-8");
//			result=new String(input.getBytes(), "UTF-8");
//			result=new String(desEncrypt(input.getBytes(), keys), "UTF-8");
//			result = StringUtils.
		} catch (Exception e) {
...
//		DESKeySpec dks = new DESKeySpec(keys.getBytes("UTF-8"));
