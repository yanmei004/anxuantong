...
import com.example.project.NewsListActivity;
...
public class ImageCycleView extends LinearLayout {
	private boolean loopPlayState = false;//变化状态 add
	
    public static int indexCurrent; //add
	/**	w
	 * 上下文
	 */
...
//		mTextViews=new TextView[imageCount];//add
		
		for (int i = 0; i < imageCount; i++) {
			mImageView = new ImageView(mContext);
//			mTextView=new TextView(mContext);//add
...
//			mTextView.setLayoutParams(new LayoutParams(imageParams, imageParams));//add
//			mTextView.setPadding(imagePadding, imagePadding, imagePadding, imagePadding);
			
			mImageViews[i] = mImageView;
//			mTextViews[i]=mTextView;//add
			if (i == 0) {
...
//		private ArrayList<TextView> mTextViewCacheList;//广告的字 add  by  yanmei 2015 01 08

		/**
		 * 图片资源列表
		 */
		private ArrayList<String> mAdList = new ArrayList<String>();//modify
//		private ArrayList<ViewPaperData> mAdList = new ArrayList<ViewPaperData>();
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			String imageUrl = mAdList.get(position);//modify
//			String imageUrl = mAdList.get(position).getImgUrl();
//			String tvData=mAdList.get(position).getTvData();
			ImageView imageView = null;
//			TextView textView=null;//add
...
//				textView=mTextViewCacheList.remove(0);
			...
			//add
//			textView.setTag(tvData);
			imageView.setTag(imageUrl);
			container.addView(imageView);
//			container.addView(textView);//add
...
//			TextView view2=(TextView) object;//add
			container.removeView(view);
//			container.removeView(view2);//add
			mImageViewCacheList.add(view);
//			mTextViewCacheList.add(view2);//add
		}
	}
